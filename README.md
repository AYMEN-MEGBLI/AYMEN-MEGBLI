...
<img>
<img src="https://user-images.githubusercontent.com/90506038/212715832-df43c335-1cbd-4583-93f0-55952216dca0.gif" height="250" width="600"></img>
    ...
    <BR><h1>Social media 📭</h1>
      ...
      <div class="hero">
        <div class="social-links">
          ...
          <a href="https://www.linkedin.com/in/aymen-megbli-70380b231/?originalSubdomain=tn"><i class="fab fa-linkedin-in"></i></a>
        </div>
      </div>
    </body>
...
.social-links a {
  ...
  color: white;
  box-shadow: 0 0 20px 10px rgba(255, 255, 0, 0.299);
  margin: 0 30px;
  border-radius: 50%;
  position: relative;
  overflow: hidden;
...
.social-links a::after {
  ...
  left: 0;
  background: #000;
  background: linear-gradient(-45deg, #fbff00, #4e4702);
  position: absolute;
  transition: 0.5s;
}
